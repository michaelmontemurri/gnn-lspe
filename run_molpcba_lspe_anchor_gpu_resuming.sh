...
#SBATCH --job-name=resume_ggcn_molpcba_anchor
...
python main_OGBMOL_graph_classification.py \
  --config configs/GatedGCN_MOLPCBA_LSPE_anchor.json \
  --checkpoint_path out/GatedGCN_MOLPCBA_LSPE_anchor_noLapEigLoss/checkpoints/GatedGCN_OGBG-MOLPCBA_GPU0_17h48m16s_on_Mar_30_2025/epoch_81.pkl
